...
<template>
  <div class="menu-wrap" :class="{ 'menu-opened': mobileMenuStatus }">
    <nav class="hidden lg:block">
      <p class="">
        地 址：
        <span class=""> 112063 </span> 台北市北投區清江路 <span class=""> 247 </span>
        巷
        <span class=""> 8 </span>
        號
        <span class=""> 1 </span>
      ...
      <p class="">
        電 話：
        <span class=""> 02-2898-6207 </span>
        / 傳真：
        <span class=""> 02-2898-6132 </span>
      </p>
      <p class="">E-mail：<span class=""> RL@rainline.com.tw </span></p>
    </nav>
